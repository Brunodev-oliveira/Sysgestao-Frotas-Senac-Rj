function s_incluir(){
	if(document.form1.matricula.value=="" || document.form1.placa.value=="" ){
		alert("Necessário Preencher o Campo MATRÍCULA E/OU PLACA");
	}
	else{
		document.form1.action = "servico_incluir.php";
