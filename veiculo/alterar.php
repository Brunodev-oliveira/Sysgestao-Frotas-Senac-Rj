<?php
	...
	if($result == 0){
		...
		<form name="form1" id="form1" action="#" method="post">
			...
			<input type="text" name="marca" id="marca" size="30" value="<?php echo $marca;?>" 
			required 
			...
			<input type="text" name="modelo" id="modelo" size="10" value="<?php echo $modelo;?>"
			required 
			...
			<input type="text" name="ano" id="ano" size="3" value="<?php echo $ano;?>"
			required 
