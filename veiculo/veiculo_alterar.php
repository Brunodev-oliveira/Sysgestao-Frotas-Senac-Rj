		...
		<div id="contents"> 
			...
			// Abre o arquivo com as conexões do BD
				...
				if(isset($_POST["alterar"])) {	
					...
					$modelo = $_POST["modelo"];
					$ano = $_POST["ano"];
					$query = mysql_query("UPDATE veiculo SET placa='$placa',marca='$marca',modelo='$modelo',ano=$ano WHERE placa = '$placa'", $cnn) or die(mysql_error());     
					...
					if($result > 0){
						...
						echo "<script> alert('Veículo não Alterado!!'); </script>";
						echo "<script> window.location='veiculo.php';</script>"; 
					}
				}									
?>						
